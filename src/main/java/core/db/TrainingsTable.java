...
/**
 * This table is different from others because it does not hold data from
 * XML/HRFs but is a mixed of computed data and data entered
 * directly by Users. Hence, there is a method recalculateEntries() that will
 * force refresh of entries.
 * This method will be called automatically after table creation and during
 * upgrade to v5.0
 */
final class TrainingsTable extends AbstractTable {
	...
	protected void initColumns() {
		columns = new ColumnDescriptor[] {
				...
				ColumnDescriptor.Builder.newInstance().setColumnName("STAMINA_SHARE")
						...
						.setSetter((p, v) -> ((TrainingPerWeek) p).setStaminaShare((Integer) v)).setType(Types.INTEGER)
	...
	/**
	 * save provided training in database (trainings still in the future will be
	 * skipped)
	 * 
