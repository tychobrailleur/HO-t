    ...
    protected void initColumns() {
        columns = new ColumnDescriptor[]{
            ColumnDescriptor.Builder.newInstance()
                    .setColumnName("PositionID")
                    .setGetter((o) -> ((FactorObject) o).getPosition())
                    .setSetter((o, v) -> ((FactorObject) o).setPosition((byte) (int) v))
                    .setType(Types.INTEGER)
                    .isNullable(false)
                    .isPrimaryKey(true)
                    .build(),
            ColumnDescriptor.Builder.newInstance()
                    .setColumnName("GKfactor")
                    .setGetter((o) -> ((FactorObject) o).getGKfactor())
                    .setSetter((o, v) -> ((FactorObject) o).setTorwart((float) v))
                    .setType(Types.REAL)
                    .isNullable(false)
                    .build(),
