...
public class Economy extends AbstractTable.Storable {
    ...
    public Economy(java.util.Properties properties) {
        ...
        // @see updateDBv500
        if (bBefore500) {
            m_iLastCostsArenaBuilding = AmountOfMoney.parse(properties.getProperty("lastcostsarenabuilding", "0"));
        }
    }
    ...
    public final AmountOfMoney getIncomeSum() {
        return m_iIncomeSum;
    }
    ...
    public final AmountOfMoney getIncomeTemporary() {
        return m_iIncomeTemporary;
    }

    public final void setIncomeSponsors(AmountOfMoney iIncomeSponsors) {
        this.m_iIncomeSponsors = iIncomeSponsors;
    }

    public final void setIncomeSponsorsBonus(AmountOfMoney iIncomeSponsorsBonus) {
        this.m_iIncomeSponsorsBonus = iIncomeSponsorsBonus;
    }

    public final AmountOfMoney getIncomeSponsors() {
        return m_iIncomeSponsors;
    }

    public final AmountOfMoney getIncomeSponsorsBonus() {
        return m_iIncomeSponsorsBonus;
    }
    ...
    public final AmountOfMoney getIncomeFinancial() {
        return m_iIncomeFinancial;
    }

    public final void setIncomeSpectators(AmountOfMoney iIncomeSpectators) {
        this.m_iIncomeSpectators = iIncomeSpectators;
    }

    public final AmountOfMoney getIncomeSpectators() {
    ...
    public final AmountOfMoney getCash() {
        return m_iCash;
    }

    public final void setExpectedWeeksTotal(AmountOfMoney iExpectedWeeksTotal) {
        this.m_iExpectedWeeksTotal = iExpectedWeeksTotal;
    }

    public final AmountOfMoney getExpectedWeeksTotal() {
        return m_iExpectedWeeksTotal;
    }
    ...
    public final AmountOfMoney getCostsSum() {
        return m_iCostsSum;
    }
    ...
    public final AmountOfMoney getCostsYouth() {
        return m_iCostsYouth;
    }
    ...
    public final AmountOfMoney getCostsTemporary() {
        return m_iCostsTemporary;
    }
    ...
    public final AmountOfMoney getCostsPlayers() {
        return m_iCostsPlayers;
    }
    ...
    public final AmountOfMoney getCostsArena() {
        return m_iCostsArena;
    }
    ...
    public final AmountOfMoney getCostsStaff() {
        return m_iCostsStaff;
    }
    ...
    public final AmountOfMoney getCostsFinancial() {
        return m_iCostsFinancial;
    }

    public final void setLastIncomeSum(AmountOfMoney iLastIncomeSum) {
        this.m_iLastIncomeSum = iLastIncomeSum;
    }

    public final AmountOfMoney getLastIncomeSum() {
        return m_iLastIncomeSum;
    }

    public final void setLastIncomeTemporary(AmountOfMoney iLastIncomeTemporary) {
        this.m_iLastIncomeTemporary = iLastIncomeTemporary;
    }

    public final AmountOfMoney getLastIncomeTemporary() {
        return m_iLastIncomeTemporary;
    }

    public final void setLastIncomeSponsors(AmountOfMoney iLastIncomeSponsors) {
        this.m_iLastIncomeSponsors = iLastIncomeSponsors;
    }

    public final void setLastIncomeSponsorsBonus(AmountOfMoney iLastIncomeSponsorsBonus) {
        this.m_iLastIncomeSponsorsBonus = iLastIncomeSponsorsBonus;
    }

    public final AmountOfMoney getLastIncomeSponsors() {
        return m_iLastIncomeSponsors;
    }

    public final AmountOfMoney getLastIncomeSponsorsBonus() {
        return m_iLastIncomeSponsorsBonus;
    }

    public final void setLastIncomeFinancial(AmountOfMoney iLastIncomeFinancial) {
        this.m_iLastIncomeFinancial = iLastIncomeFinancial;
    }

    public final AmountOfMoney getLastIncomeFinancial() {
        return m_iLastIncomeFinancial;
    }

    public final void setLastIncomeSpectators(AmountOfMoney iLastIncomeSpectators) {
        this.m_iLastIncomeSpectators = iLastIncomeSpectators;
    }

    public final AmountOfMoney getLastIncomeSpectators() {
        return m_iLastIncomeSpectators;
    }

    public final void setLastWeeksTotal(AmountOfMoney iLastWeeksTotal) {
        this.m_iLastWeeksTotal = iLastWeeksTotal;
    }

    public final AmountOfMoney getLastWeeksTotal() {
        return m_iLastWeeksTotal;
    }
    ...
    public final AmountOfMoney getLastCostsSum() {
        return m_iLastCostsSum;
    }

    public final void setLastCostsYouth(AmountOfMoney iLastCostsYouth) {
        this.m_iLastCostsYouth = iLastCostsYouth;
    }

    public final AmountOfMoney getLastCostsYouth() {
        return m_iLastCostsYouth;
    }

    public final void setLastCostsTemporary(AmountOfMoney iLastCostsTemporary) {
        this.m_iLastCostsTemporary = iLastCostsTemporary;
    }

    public final AmountOfMoney getLastCostsTemporary() {
        return m_iLastCostsTemporary;
    }

    public final void setLastCostsPlayers(AmountOfMoney iLastCostsPlayers) {
        this.m_iLastCostsPlayers = iLastCostsPlayers;
    }

    public final AmountOfMoney getLastCostsPlayers() {
        return m_iLastCostsPlayers;
    }

    public final void setLastCostsArena(AmountOfMoney iLastCostsArena) {
        this.m_iLastCostsArena = iLastCostsArena;
    }

    public final AmountOfMoney getLastCostsArena() {
        return m_iLastCostsArena;
    }

    public final void setLastCostsStaff(AmountOfMoney iLastCostsStaff) {
        this.m_iLastCostsStaff = iLastCostsStaff;
    }

    public final AmountOfMoney getLastCostsStaff() {
        return m_iLastCostsStaff;
    }

    public final void setLastCostsFinancial(AmountOfMoney iLastCostsFinancial) {
        this.m_iLastCostsFinancial = iLastCostsFinancial;
    }

    public final AmountOfMoney getLastCostsFinancial() {
        return m_iLastCostsFinancial;
    }

    public final void setSponsorsPopularity(int iSponsorsPopularity) {
        this.m_iSponsorsPopularity = iSponsorsPopularity;
    }
    ...
    public final void setSupPopularity(int iSupportersPopularity) {
        this.m_iSupportersPopularity = iSupportersPopularity;
    }
    ...
    public final void setIncomeSoldPlayers(AmountOfMoney iIncomeSoldPlayers) {
        this.m_iIncomeSoldPlayers = iIncomeSoldPlayers;
    }
    ...
    public final void setIncomeSoldPlayersCommission(AmountOfMoney iIncomeSoldPlayersCommission) {
        this.m_iIncomeSoldPlayersCommission = iIncomeSoldPlayersCommission;
    }
    ...
    public final void setCostsBoughtPlayers(AmountOfMoney iCostsBoughtPlayers) {
        this.m_iCostsBoughtPlayers = iCostsBoughtPlayers;
    }
    ...
    public final void setCostsArenaBuilding(AmountOfMoney iCostsArenaBuilding) {
        this.m_iCostsArenaBuilding = iCostsArenaBuilding;
    }
    ...
    public final void setLastIncomeSoldPlayers(AmountOfMoney iLastIncomeSoldPlayers) {
        this.m_iLastIncomeSoldPlayers = iLastIncomeSoldPlayers;
    }

    public final AmountOfMoney getLastIncomeSoldPlayers() {
        return m_iLastIncomeSoldPlayers;
    }
