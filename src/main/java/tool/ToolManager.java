...
public class ToolManager {
    private final HOMainFrame mainFrame;
    ...
    public ToolManager(HOMainFrame mainFrame) {
        this.mainFrame = mainFrame;
    }

    public JMenu getToolMenu() {
        m_jmiArenaSizer.addActionListener(e -> new ArenaSizerDialog(mainFrame).setVisible(true));
        m_jmToolsMenu.add(m_jmiArenaSizer);

        m_jmiKeeperTool.addActionListener(e -> new KeeperToolDialog(mainFrame).setVisible(true));
        m_jmToolsMenu.add(m_jmiKeeperTool);

        m_jmiInjuryCalculator.addActionListener(e -> new InjuryDialog(mainFrame).setVisible(true));
        ...
        m_jmiNotepad.addActionListener(e -> {
            NotepadDialog notepad = new NotepadDialog(mainFrame, TranslationFacility.tr("Notizen"));
            notepad.setVisible(true);
        });
        m_jmToolsMenu.add(m_jmiNotepad);

        m_jmiHrfExplorer.addActionListener(
                e -> new HrfExplorerDialog(mainFrame, mainFrame.getApplicationContext()).setVisible(true));
